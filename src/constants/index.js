...
const VN_REGION_TRUNK =
    'http://overpass-api.de/api/interpreter?data=[out:json];way["highway"~"trunk|road|primary|secondary|tertiary"](9.0,102.0,24.0,110.0);out%20geom;';
...
const VN_REGION_RESIDENTIAL =
    'http://overpass-api.de/api/interpreter?data=[out:json];way["landuse"="residential"](9.0,102.0,24.0,110.0);out geom;';
