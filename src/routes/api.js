...
router.get('/residential/pull', api.pullResidential);
...
router.get('/residential/get-all', api.getAllResidential);
...
router.post('/trunks/insert-relations', api.insertTrunkRelations);
router.post('/trunks/insert-relations-by-name', api.insertTrunkRelationsByName);
